...
@section('content')
                    <div class="col-md-12 gizle" style="padding-right: 0px !important; padding-left: 0px !important;">
                        <div class="baslik-2">
                            <p class="box-title-2">STAJ GİRİŞİ YAPMIŞ ÖĞRENCİLER <small><small> ( {{Auth::User()->FakulteBilgisi[0]["AktifDonem"]}} Dönemi ) </small></small>
                             <a href="#" style="margin-top:13px; margin-right: 10px" onclick="window.print();" class="btn btn-info pull-right"><i class="fa fa-print"></i> Sayfayı Yazdır</a></p>
