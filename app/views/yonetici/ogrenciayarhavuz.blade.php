...
@section('content')
                ...
                <div class="col-md-12">
                <div class="row">
                    <div class="gizle col-md-12">
                            <center> {{$Ogrenciler->Links()}}</center><br>
                            <small><small> {{Auth::user()->Donem}} Dönemi İçin {{Auth::user()->FakulteBilgisi[0]["Fakulte"]}}'na  Ait Öğrenci Sayısı : {{$OgrenciSayisi}}</small></small>
                    </div>
                </div>
                </div>
            </div>
