    ...
    <body>
            ...
            <div class="container">
                <div class="row ust-kisim">
                    <div class="col-md-4 col-md-offset-1">
                        <ul class="top-menu">
                            <li class="top-li"><a class="menu-link-beyaz" href="index.html">Anasayfa</a></li>
                    ...
                    <div class="col-md-4 col-md-offset-2"  style="float:right; padding-left:0 !important;">
                        <div class="row">
                            ...
                            <div class="col-md-2" style="padding-left:0 !important;">
                                <button type="button" class="btn btn-yesil btn-sm">Tamam</button>
                            </div>
                        </div>
                        <div class="row">
        ...
        <content>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <span class="page-big-title">Şirket Profilini Düzenle</span>
                    </div>
                    <div class="col-md-3">
                        <center>
                            <div class="logo-cerceve">
                                <img src="img/sirket.png"  height="130px">
                            </div>
                            <div class="top-10"></div>
                            <p class="logo-alt">İSTANBUL / BAKIRKÖY</p> 
                        </center>
                        <div class="top-10"></div>
                        <div class="row">
                            <div class="col-md-12 sekme-buton">
                                <a href="#" class="sekme-link">
                                    ...
                                    <span class="sekme-text">MESAJLAR</span>
                                </a>
                            </div>
                            <div class="col-md-12 sekme-buton">
                                <a href="#" class="sekme-link">
                                    ...
                                    <span class="sekme-text">ÖĞRENCİLER</span>
                                </a>
                            </div>
                            <div class="col-md-12 sekme-buton">
                                <a href="#" class="sekme-link">
                                    ...
                                    <span class="sekme-text">DEVAMSIZLIK GİRİŞİ</span>
                                </a>
                            </div>
                            <div class="col-md-12 sekme-buton">
                                <a href="#" class="sekme-link">
                    ...
                    <div class="col-md-9" style="padding-right: 0px !important; padding-left: 0px !important;">
                        <ul class="sirket-name"><li class="name-li">INTUIT PROJE GELİŞTİRME A.Ş.</li></ul>
                        <div class="baslik">
                        ...
                        <div class="row">
                            <div class="col-md-6 ilan">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img class="ilan-img" src="img/sirket.png">
                                    </div>
                        ...
                        <div class="top-10"></div>
                        <div class="baslik">
                            <p class="box-title">BAŞVURULAR</p>
                            <a href="#" class="sag-link">Tümünü gör...</a>
                        </div>
                        <div class="icerik-4">
                            <center>
                                <ul class="basv-ogr">
                                    <li>
                                        <a href="#">
                                            <img class="ogr-img" src="img/ogr.png">
                                            <p class="ogr-isim">GAMZE MERZADE</p>
                                            <p class="ogr-okul">İSTANBUL TEKSTİL MESLEK LİSESİ</p>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                        ...
                        <div class="top-10"></div>
                        <div class="baslik">
                            <p class="box-title">SİZE UYGUN ÖĞRENCİLER</p>
                            <a href="#" class="sag-link">Tümünü gör...</a>
                        </div>
                        <div class="icerik-4">
                            <center>
        ...
        <footer>
            <div class="row">
                <div class="container"> 
                    ...
                    <div class="col-md-4">
                        <a href="index.html"><img src="img/logo2.png" width="200"></a>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <a href="#"><img src="img/ege.png" width="100" style="float:right;"></a>
                    </div>
                </div>
            </div>
        </footer>
